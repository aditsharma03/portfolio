...
const Art = () => {
    ...
    return (
        ...
        <div className='mb-4 text-4xl font-bold text-zinc-800 tracking-widest underline'>
        My Artworks
        </div>
            ...
            images.map( (image, index) => {
                return (
                    ...
                    <img src={image.src} className='w-full bg-rose-100 border-8 border-solid border-zinc-900 shadow-md shadow-black
                     hover:border-zinc-900 hover:z-10 hover:scale-110 hover:shadow-2xl hover:shadow-black  duration-500 delay-75' />
                    </div>
                )
            } )
        }
